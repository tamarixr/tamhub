 -- Normal assets (when health is 50 or above)
...
if humanoidRootPart and humanoidRootPart:IsA("BasePart") and humanoid then
    if humanoid.Health < 50 then
        ...
        if part1 and part1:IsA("BasePart") and part2 and part2:IsA("BasePart") and part3 and part3:IsA("BasePart") then
            ...
            local targetPosition = part2.Position + Vector3.new(2, 0, 0) -- Move part1 next to part2
            ...
            loadModelForClient(flashAssetId, part3.CFrame, 5)
            part3:Destroy()
            ...
            -- Clean up the white flash effect
            screenGui:Destroy()
            -- Reset HipHeight after 3 seconds
