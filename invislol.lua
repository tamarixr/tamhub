...
Sound:Play()
game:GetService("StarterGui"):SetCore("SendNotification",{["Title"] = "Skidded Invisible Toggle Loaded",["Text"] = "Press "..Keybind.." to become change visibility. (skidded by dfptt)",["Duration"] = 20,["Button1"] = "Okay."})
